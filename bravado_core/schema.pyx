...
cpdef has_format(swagger_spec, schema_object_spec):
...
cpdef bint is_prop_nullable(swagger_spec, schema_object_spec):
...
cpdef bint is_ref_helper(dict spec) except -1:
    cdef str r = '$ref' 
#    return r in spec and is_dict_like(spec)
    return r in spec
